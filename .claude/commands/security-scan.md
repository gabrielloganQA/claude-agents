...
argument-hint: "[opcional: --apenas-audit, --apenas-secrets, ou --diff pra shift-left]"
---
...
- `--diff`: modo shift-left — só linhas adicionadas no diff `main...HEAD`. Reporta inline, não abre issue.
